                        ...
                        if(byteCount > 0)
                        {
                            ...
                            handler.post(new Runnable()
                            {
                                public void run()
                                {
                                    if(string.equals("3"))
                                    {
                                        lockstate.setText("Lock State: LOCKED"); // Changes the lock state text
                                        lock_img.setImageResource(R.drawable.lockstate); //Changes the lock state icon
                                    }
                                    else if(string.equals("4"))
                                    {
                                        lockstate.setText("Lock State: UNLOCKED");
